...
<execution_context>
@D:/projects codes/rota ai/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @D:/projects codes/rota ai/.claude/get-shit-done/workflows/docs-update.md end-to-end.
