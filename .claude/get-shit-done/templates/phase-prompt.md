...
<!-- For checkpoint task examples and patterns, see @D:/projects codes/rota ai/.claude/get-shit-done/references/checkpoints.md -->
...
See `D:/projects codes/rota ai/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/projects codes/rota ai/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/projects codes/rota ai/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
