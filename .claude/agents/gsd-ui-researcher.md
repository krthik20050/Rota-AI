...
Use template from `D:/projects codes/rota ai/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/projects codes/rota ai/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/projects codes/rota ai/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
