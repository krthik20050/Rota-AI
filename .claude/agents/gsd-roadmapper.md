...
Reference full template: `D:/projects codes/rota ai/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/projects codes/rota ai/.claude/get-shit-done/templates/state.md`.
