---
title: "Rota AI: How to Set Up a Free Groq API Key for Voice Dictation"
...
Groq gives you free access to Whisper Large v3 for transcription. The free tier is generous enough for daily use. Setup takes like 5 minutes. You don't even need a credit card. Just sign up, grab your key, and paste it into Rota AI. Done.
...
**Speed.** Like honestly it's absurd how fast Groq is. They use these LPUs (Language Processing Units) and the inference is near-instant. You talk, you get text back. Barely any latency.

**Free tier.** The free tier is actually usable. Not one of those "try it for 11 minutes and pay us forever" situations. You get enough requests per day for regular voice dictation without spending a dime.
...
**No credit card required.** This one matters. A lot of providers want your card upfront just to try things. Groq doesn't. Sign up with your email and you're in.

Tbh if you are building anything with voice input and you don't want to deal with complex setup, Groq is the move.
...
Open your browser and head to [console.groq.com](https://console.groq.com). That's the GroqCloud console. This is where everything lives.
...
Click the copy button next to the key. Or highlight it and copy manually. Either way, get it on your clipboard.
...
Rota AI will now use Groq's Whisper Large v3 for all your voice dictation. Fast, free, accurate.

---

## Rate Limits and How Round Robin Helps

Ok so the free tier does have limits. Here is the deal.

Groq's free tier gives you a certain number of requests per minute and per day. The exact numbers change sometimes so check their docs for the current limits. But for most people doing voice dictation throughout the day, you won't hit them.
...
your mileage may vary depending on how much you use it. But for most people, one key is plenty.
...
- There's a trailing space when you pasted it. Delete the field and paste again carefully
...
Gemini's free tier is also pretty generous. And since it's Google, the transcription quality is competitive. Having both Groq and Gemini keys configured means Rota AI can fall back automatically if one provider has issues.

Fr, I recommend setting up both. Takes an extra 3 minutes and you'll thank yourself later.
...
**Is Groq really free?**
Yes. The free tier is real and it doesn't require a credit card. There are paid tiers if you need more capacity but the free one is enough for most people.
...
No. If you can copy and paste, you can set this up. The whole process is clicking buttons in a dashboard.
...
That's the whole thing. Get your free Groq key, plug it into Rota AI, and start dictating. It's fast, it's free, and it just works.
