---
title: "Why Privacy Matters More Than You Think in Voice Dictation — Rota AI"
description: "Your voice is biometric data. Here is what actually happens to your audio in cloud dictation services, the GDPR implications, and how Rota AI handles privacy with local mode, zero telemetry, and DPAPI encryption."
...
your mileage may vary depending on where you live. But the reality is that if you care about voice dictation privacy, you should not rely on regulations alone. You should use tools that do not send your data to the cloud in the first place.
