...
I am a student. When I first tried Wispr Flow, I was amazed.

The way it understood what I was saying, cleaned it up, and dropped it into whatever app I was using. It was a glimpse of the future. Typing felt slow by comparison. My fingers felt inefficient.

After a week of using it, going back to a keyboard was a downgrade.

Then my 14-day free trial ended. I could not go back to typing.
...
I spent months learning how voice dictation actually works under the hood. Things I never expected to need to know:
...
**The stack:** Python, PySide6, Faster Whisper, Silero VAD, Groq, Gemini, SQLite. The UI is pure black, custom styled, floating pill overlay with an audio-reactive waveform. Every pixel is intentional.
...
The code is all on GitHub. Every line. You can audit exactly what it does with your voice data.
...
If you are a student and this inspires you to build something, do it. You do not need a big team. You do not need funding. You need curiosity and the stubbornness to keep going when things break (and they will, constantly).
