---
title: "Rota AI: How Round Robin Scheduling Saves My API Rates"
description: "Running into API rate limits with Rota AI? Here is how I used round robin scheduling from my OS class to rotate across multiple API keys and keep dictation running smooth."
...
That is the whole algorithm. It is literally 10 lines of code.
...
your mileage may vary depending on your traffic patterns, but for us, round robin was the clear winner.
...
this failure handling is what makes the whole system production ready. The round robin rotation is the foundation. The retry logic is the safety net.
