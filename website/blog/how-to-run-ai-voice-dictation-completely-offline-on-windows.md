---
title: "Rota AI: How to Run AI Voice Dictation Completely Offline on Windows"
description: "Use Ollama to run voice dictation 100% offline on Windows. Your voice data never leaves your machine. Works on 8GB RAM laptops."
...
That is why I built offline mode into Rota AI and honestly, it is one of my favorite features.

## Why Offline Matters

about cloud-based dictation. Every time you speak, your audio gets packaged up, sent to a server somewhere, transcribed, and sent back. That happens in milliseconds so it feels instant. But your voice data still left your machine.
...
The tradeoff: you need enough RAM to run the model. and local transcription is slower than cloud. But for most people, it is good enough.
...
Go to ollama.com and download the Windows installer. Run it. That is it.
...
The small model is about 250MB. Medium is about 500MB. They download once and stay on your machine forever.

### 3. Configure Rota AI

Open Rota AI settings. Go to Transcription > Backend. Select "Ollama Local." Choose your model size. Hit save.

Done. Now when you press F9 and speak, the audio stays on your machine, gets transcribed by your local Whisper model, gets cleaned up, and gets injected into your app.
...
I use medium. It is the sweet spot between speed and accuracy. If you have 8GB RAM, use small. It is honestly not that bad.
...
So yeah, local is slower. But it is not painfully slow. It is like, you finish speaking, count to 3, and the text appears. Completely usable.
...
Cloud for speed and accuracy first. Local for privacy and offline use. You can switch between them in settings whenever.
