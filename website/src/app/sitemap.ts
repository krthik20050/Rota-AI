...
export default function sitemap() {
  ...
  return [
    ...
    { url: `${SITE_URL}/vs/wispr-flow`, lastModified: new Date(), changeFrequency: "weekly" as const, priority: 0.7 },
    { url: `${SITE_URL}/vs/superwhisper`, lastModified: new Date(), changeFrequency: "weekly" as const, priority: 0.7 },
