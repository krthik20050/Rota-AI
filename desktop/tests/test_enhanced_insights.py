...
from utils.text_metrics import count_syllables, calculate_text_metrics, TextMetrics
from services.enhanced_insights import EnhancedInsightsService, Persona, DailyChallenge
...
def test_calculate_text_metrics():
    ...
    assert metrics.grade_level in ["Academic / Dense", "Executive / Advanced", "Clear Professional", "Standard Conversational", "Simple / Direct"]
...
def test_enhanced_insights_service():
    ...
    assert insights["advanced_coaching"]["speech_coach"]["focus_title"] == coaching["speech_coach"]["focus_title"]
