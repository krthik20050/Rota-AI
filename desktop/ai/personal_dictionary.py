...
class PersonalDictionary:
    ...
    Storage: %APPDATA%/RotaAI/personal_dictionary.json (Windows),
    %XDG_DATA_HOME%/rota-ai/personal_dictionary.json (Linux),
    ~/Library/Application Support/RotaAI/personal_dictionary.json (macOS)
    """
